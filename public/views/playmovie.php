...
<div id="Play_movie_screen">
	<div id="Top">
		...
		<img id="Search_bb" src="public/img/Search_bb.png" srcset="public/img/Search_bb.png 1x, public/img/Search_bb@2x.png 2x">
			...
			<div id="Home_Movies_Series_R">
				<span>Home          Movies          Series          Recently added</span>
			</div>
		</div>
	</div>
	...
	<div id="Header_">
		...
		<div id="Component_68__22" class="Component_68___22">
			...
			<div onclick="application.goToTargetView(event)" id="Home_Movies_Series_R_bf">
				<span></span><span style="color:rgba(255,255,255,0.345);">Series</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Home_Movies_Series_R_bg">
				<span>Recently added</span>
			</div>
			<div id="Home_Movies_Series_R_bh">
				<span>Series</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Home_Movies_Series_R_bi">
				<span>Movies</span>
			</div>
